...
## Valor Preditivo Positivo — VPP (Precisão)
...
comparacao_modelos |>
  ...
  labs(
    ...
    title = "Sensibilidade para detectar baixo peso ao nascer",

    subtitle = "Comparação da sensibilidade entre os modelos avaliados",
