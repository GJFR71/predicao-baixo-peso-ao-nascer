...
Além de apresentar o maior Recall entre os modelos avaliados, o modelo Lasso também demonstrou ganho em relação à triagem clínica estimada a partir dos registros disponíveis na base, ampliando a capacidade de identificação dos casos de baixo peso ao nascer.
...
## Comparação com a triagem clínica estimada
...
| Estratégia | Capacidade de identificação dos casos de baixo peso |
|---|---:|
| Triagem clínica estimada | 47,0% |
| Modelo Lasso | 56,5% |

Os resultados indicam que a triagem clínica estimada foi capaz de identificar cerca de **47% dos casos de baixo peso ao nascer**. Com o uso do modelo Lasso, essa capacidade de identificação aumentou para aproximadamente **56,5%**.

Em termos práticos, isso representa um ganho absoluto de aproximadamente **9,5 pontos percentuais** e uma melhora relativa de cerca de **20,2%** na capacidade de identificação dos casos de baixo peso ao nascer.
...
Com base na comparação realizada neste projeto, uma triagem clínica estimada a partir dos registros disponíveis seria capaz de identificar aproximadamente **47% dos casos de baixo peso ao nascer**. Com o uso do modelo Lasso, essa capacidade de identificação aumenta para cerca de **56,5%**.
